Anladım, önce change_dir.sh ve change_dest.sh dosyalarının çalıştırılması gerektiğini belirttiniz. Aşağıdaki README dosyasını bu sıralamayı dikkate alarak güncelledim:
